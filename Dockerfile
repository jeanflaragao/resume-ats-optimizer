...
# docker build -t resume_ats_optimizer .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name resume_ats_optimizer resume_ats_optimizer
